...
label_font = pygame.font.Font('Roboto-BoldItalic.ttf', 32)
medium_font = pygame.font.Font('Roboto-BoldItalic.ttf', 20)
...
hi_hat = mixer.Sound("808 Samples/hi hat (1).WAV")
snare = mixer.Sound("808 Samples/snare.WAV")
kick = mixer.Sound("808 Samples/kick (20).WAV")
crash = mixer.Sound("808 Samples/bass.WAV")
...
def draw_save_menu(beat_name, typing):
    ...
    menu_text = label_font.render(
        'SAVE MENU: Enter the name for this beat', True, white)
...
def draw_load_menu(index):
    ...
    pygame.draw.rect(screen, black, [0, 0, WIDTH, HEIGHT])
    menu_text = label_font.render(
        'LOAD MENU: Select beat to load', True, white)
    ...
    delete_btn = pygame.draw.rect(
        screen, gray, [WIDTH//2-500, HEIGHT*.87, 200, 100], 0, 5)
...
while run:
    ...
    bpm_text = medium_font.render('Beates per Minute', True, white)
    ...
    beats_text = medium_font.render('Beates in Loop', True, white)
        ...
        if event.type == pygame.MOUSEBUTTONUP and not save_menu and not load_menu:
            ...
            if save_menu:
                ...
                if saving_button.collidepoint(event.pos):
                    ...
                    typing = False
                    beat_name = ''
        if event.type == pygame.TEXTINPUT and type:
